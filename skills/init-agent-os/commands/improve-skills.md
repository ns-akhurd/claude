...
All of the Skills in this project are located in `.claude/skills/`. Each Skill has its own folder and inside each Skill folder is a file called `SKILL.md`.
...
Analyze and read the skill file to understand what it is, what it should be used for, and when it should be used. Look to these places to read and understand each skill:
